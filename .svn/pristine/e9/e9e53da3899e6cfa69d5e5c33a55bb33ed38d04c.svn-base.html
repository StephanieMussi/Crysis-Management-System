...
<body>
	...
	<div class="col-md-12">
	<div class="row">
		<h3 class="label">Resolved Incident List </h3>
	</div>
	<div class="row">
		...
		<tbody>
			...
			?>
						<tr>
							...
							<td><a href="pmo_resolved_view_more_info.php?action=viewMoreResolved&incidentId=<?php echo $row["incidentId"]; ?>"><i class="fas fa-eye"></i></a></td>
						</tr>
			<?php
					}
				}
