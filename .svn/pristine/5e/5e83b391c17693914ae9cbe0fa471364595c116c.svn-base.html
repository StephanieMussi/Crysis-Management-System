...
function edit(){
	...
	url = "cco_file_accident.php?edit=true&name="+name+"&mobileNo="+mobileNo+"&location="+location+"&unitNo="+unitNo+"&emergencyType="+emergencyType+"&others="+others+"&fireFighting="+fireFighting+"&emergencyAmbulance="+emergencyAmbulance+"&rescueAndEvacuation="+rescueAndEvacuation+"&gasLeakControl="+gasLeakControl+"&remarks="+remarks;
