...
$finalresult = $incidentcontroller->getReportIncidents("30");
...
$resetaveragetime = number_format($averagetime, 1, '.', ' ');
...
$pdf->Ln(6);
$pdf->Cell(0,7,'Average time taken to resolve cases : '.$resetaveragetime." minutes");
