...
<body>
	...
	<div class="col-md-12">
		...
		?>
		<h3 class="label">Incident List Awaiting for Approval</h3><br/>
		...
		<tbody>
			...
			?>
						<tr>
							...
							<td><a href="pmo_view_more_info.php?viewMore=true&incidentId=<?php echo $row["incidentId"]; ?>"><i class="fas fa-eye"></i></a></td>
						</tr>
			<?php
					}
				}
